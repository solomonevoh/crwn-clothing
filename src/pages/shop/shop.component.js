...
import { firestore, snapShot, convertCollectionSnapshotToMap } from  '../../firebase/firebase.utils';
...
class ShopPage extends React.Component {
  ...
  componentDidMount() {
    ...
    this.unsubscribeFromSnapshot = snapShot(collectionRef, async snapshot => {
